...
const Header = () => {
  ...
  return (
    <div className=' '>
      <>
        <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-[#130f40] shadow">
          <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
            ...
            >
              ...
              <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                ...
                <li className="flex items-center ml-4">
                  <Link className='text-white font-bold text-md  hover:text-gray-300'  to={'/'}>Blog</Link>
                </li>
